...
command_invalid_error_info = "Неверная команда, используй /help для помощи"
user_no_permission_info = "Я вас не звал, идите... (с)"
group_no_permission_info = "Я вас (группу) не звал, идите... (с)"
gemini_err_info = f"Что-то не так!\nВведенный тобой контент может быть неприемлемым. Измени его и повтори попытку."
